...
### FILE MODIFICATO RISPETTO ALL'ORIGINALE
...
Function DisableTelemetry {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare la telemetria? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione della telemetria..."
...
Function EnableTelemetry {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare la telemetria? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione della telemetria..."
...
Function DisableWiFiSense {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare Wi-Fi Sense? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione di Wi-Fi Sense..."
...
Function EnableWiFiSense {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare Wi-Fi Sense? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione Wi-Fi Sense..."
	If (!(Test-Path "HKLM:\SOFTWARE\Microsoft\PolicyManager\default\WiFi\AllowWiFiHotSpotReporting")) {
		New-Item -Path "HKLM:\SOFTWARE\Microsoft\PolicyManager\default\WiFi\AllowWiFiHotSpotReporting" -Force | Out-Null
	}
...
Function DisableSmartScreen {
	Write-Output "Disattivazione Filtro SmartScreen..."
...
Function EnableSmartScreen {
	Write-Output "Attivazione Filtro SmartScreen..."
...
Function DisableWebSearch {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare la ricerca web con Bing nel menu Start? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione Bing Search nel menu Start..."
...
Function EnableWebSearch {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare la ricerca web con Bing nel menu Start? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione Bing Search nel menu Start..."
...
Function DisableAppSuggestions {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare l'installazione automatica di applicazioni superflue? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione delle app suggerite..."
...
Function EnableAppSuggestions {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare le app suggerite? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione app suggerite..."
...
Function DisableActivityHistory {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare la cronologia delle attivita' usata per la Timeline? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione Activity History..."
...
Function EnableActivityHistory {
	Write-Output "Attivazione Activity History..."
...
Function DisableBackgroundApps {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare l'attivita' delle applicazioni Microsoft Store in background? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disabilitazione attivita' in background delle app..."
...
Function EnableBackgroundApps {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare attivita' in background delle app? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione app in background..."
...
Function DisableSensors {
	Write-Output "Disattivazione sensori..."
...
Function EnableSensors {
	Write-Output "Attivazione sensori..."
...
Function DisableLocation {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare i servizi di geolocalizzazione? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione servizi di geolocalizzazione..."
	If (!(Test-Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\LocationAndSensors")) {
		New-Item -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\LocationAndSensors" -Force | Out-Null
	}
...
Function EnableLocation {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare i servizi di geolocalizzazione? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione servizi di geolocalizzazione..."
...
Function DisableMapUpdates {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare aggiornamento automatico delle mappe? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivare aggiornamento automatico delle mappe Microsoft..."
...
Function EnableMapUpdates {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare aggiornamento automatico delle mappe? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione aggiornamento automatico delle mappe Microsoft..."
...
Function DisableFeedback {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare il Feedback a Microsoft? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione Feedback..."
...
Function EnableFeedback {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare il Feedback Microsoft? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione Feedback..."
...
Function DisableTailoredExperiences {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare suggerimenti e raccomandazioni Microsoft? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione Tailored Experiences..."
...
Function EnableTailoredExperiences {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare suggerimenti e raccomandazioni Microsoft? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione Tailored Experiences..."
...
Function DisableAdvertisingID {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare l'ID univoco usato per la pubblicita'? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione Advertising ID..."
...
Function EnableAdvertisingID {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare l'ID univoco usato per la pubblicita'? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione Advertising ID..."
...
Function DisableWebLangList {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare la visualizzazione di contenuti basati sulla lingua? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione accesso da parte dei siti web alle lingue utilizzate..."
...
Function EnableWebLangList {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare la visualizzazione di contenuti basati sulla lingua? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione accesso da parte dei siti web alle lingue utilizzate..."
...
Function DisableCortana {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare Cortana? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione Cortana..."
...
Function EnableCortana {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare Cortana? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione Cortana..."
...
Function DisableBiometrics {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare i servizi biometrici? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione biometric services..."
...
Function EnableBiometrics {
	Write-Output "Attivazione biometric services..."
...
Function DisableCamera {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare la videocamera? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione videocamera..."
...
Function EnableCamera {
	Write-Output "Attivazione videocamera..."
...
Function DisableErrorReporting {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare l'invio degli errori a Microsoft? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione Error reporting..."
...
Function EnableErrorReporting {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare l'invio degli errori a Microsoft? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione Error reporting..."
...
Function SetP2PUpdateLocal {
	If ($global:accept) {
	$Readhost = Read-Host "- Limitare la distribuzione degli aggiornamenti alla sola rete locale? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione della distribuzione P2P degli aggiornamenti di Windows alla sola rete locale..."
...
Function SetP2PUpdateInternet {
	If ($global:accept) {
	$Readhost = Read-Host "- Estendere la distribuzione degli aggiornamenti alla rete locale e Internet? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Sblocco degli aggiornamenti P2P di Windows Update (distribuzione anche in Internet)..."
	If ([System.Environment]::OSVersion.Version.Build -eq 10240) {
		# Method used in 1507
		If (!(Test-Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\DeliveryOptimization\Config")) {
			New-Item -Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\DeliveryOptimization\Config" | Out-Null
...
Function SetP2PUpdateDisable {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare completamente la distribuzione degli aggiornamenti P2P di Windows Update? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione completa ottimizzazione P2P Windows Update P2P..."
	If ([System.Environment]::OSVersion.Version.Build -eq 10240) {
		# Method used in 1507
		If (!(Test-Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\DeliveryOptimization\Config")) {
			New-Item -Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\DeliveryOptimization\Config" | Out-Null
...
Function DisableDiagTrack {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare tutti i servizi di Consumer Experience? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione Connected User Experiences and Telemetry Service..."
...
Function EnableDiagTrack {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare tutti i servizi di Consumer Experience? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione e avvio Connected User Experiences and Telemetry Service ..."
...
Function DisableWAPPush {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare il servizio push WAP? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione Device Management WAP Push Service..."
...
Function EnableWAPPush {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare il servizio push WAP? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione e avvio Device Management WAP Push Service..."
...
Function SetCurrentNetworkPrivate {
	If ($global:accept) {
	$Readhost = Read-Host "- Impostare come privata la connessione corrente (permettere la condivisione di file)? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Impostazione del profilo di rete come privato..."
...
Function SetCurrentNetworkPublic {
	If ($global:accept) {
	$Readhost = Read-Host "- Impostare come pubblica la connessione corrente (non permettere la condivisione di file)? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Impostazione del profilo di rete come pubblico..."
...
Function HideAccountProtectionWarn {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare l'avviso in Windows Defender quando non si usa un account Microsoft? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione avviso Account Protection..."
...
Function ShowAccountProtectionWarn {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare l'avviso in Windows Defender quando non si usa un account Microsoft? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione avviso Account Protection..."
...
Function DisableScriptHost {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare il supporto dei file di scripting? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione Windows Script Host..."
	Set-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Windows Script Host\Settings" -Name "Enabled" -Type DWord -Value 0
}

# Enable Windows Script Host
Function EnableScriptHost {
	Write-Output "Attivazione Windows Script Host..."
...
Function EnableF8BootMenu {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare il supporto per il tasto F8 all'avvio? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione tasto F8 al boot..."
...
Function DisableF8BootMenu {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare il supporto per il tasto F8 all'avvio? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione tasto F8 al boot..."
...
Function DisableMaintenanceWakeUp {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare i risvegli notturni del sistema per attivare Windows Update? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione risvegli notturni per la manutenzione automatica..."
	If (!(Test-Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU")) {
		New-Item -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU" -Force | Out-Null
	}
...
Function EnableMaintenanceWakeUp {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare i risvegli notturni del sistema per attivare Windows Update? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione risvegli notturni per la manutenzione automatica..."
...
Function DisableRemoteAssistance {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare l'assistenza remota? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione Remote Assistance..."
...
Function EnableRemoteAssistance {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare l'assistenza remota? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione Remote Assistance..."
...
Function DisableLockScreenBlur {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare l'effetto sfocato nella schermata di blocco? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione Lock screen Blur..."
...
Function EnableLockScreenBlur {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare l'effetto sfocato nella schermata di blocco? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione Lock screen Blur..."
...
Function DisableAccessibilityKeys {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare tasti accessibilita'? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione tasti accessibilita'..."
...
Function EnableAccessibilityKeys {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare tasti accessibilita'? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione tasti accessibilita'..."
...
Function ShowTaskManagerDetails {
	If ($global:accept) {
	$Readhost = Read-Host "- Mostrare tutti i dettagli nel Task Manager? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione di tutti i dettagli nel Task Manager..."
...
Function HideTaskManagerDetails {
	If ($global:accept) {
	$Readhost = Read-Host "- Nascondere i dettagli nel Task Manager? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione dettagli Task Manager..."
	$preferences = Get-ItemProperty -Path "HKCU:\Software\Microsoft\Windows\CurrentVersion\TaskManager" -Name "Preferences" -ErrorAction SilentlyContinue
	If ($preferences) {
...
Function ShowFileOperationsDetails {
	If ($global:accept) {
	$Readhost = Read-Host "- Mostrare i dettagli durante lo svolgimento delle operazioni sui file? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione dettagli sulle operazioni file..."
...
Function HideFileOperationsDetails {
	If ($global:accept) {
	$Readhost = Read-Host "- Nascondere i dettagli durante lo svolgimento delle operazioni sui file? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione dettagli sulle operazioni file..."
...
Function ShowSmallTaskbarIcons {
	If ($global:accept) {
	$Readhost = Read-Host "- Mostrare icone piccole nella barra delle applicazioni? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione icone piccole per la barra delle applicazioni..."
...
Function ShowLargeTaskbarIcons {
	If ($global:accept) {
	$Readhost = Read-Host "- Mostrare icone grandi nella barra delle applicazioni? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione icone grandi per la barra delle applicazioni..."
...
Function HideTaskbarPeopleIcon {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare l'icona Persone nella barra delle applicazioni? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione icona Persone..."
...
Function ShowTaskbarPeopleIcon {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare l'icona Persone nella barra delle applicazioni? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione icona Persone..."
...
Function ShowTrayIcons {
	If ($global:accept) {
	$Readhost = Read-Host "- Mostrare tutte le icone nella traybar? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione visualizzazione di tutte le icone nella traybar..."
	If (!(Test-Path "HKCU:\Software\Microsoft\Windows\CurrentVersion\Policies\Explorer")) {
		New-Item -Path "HKCU:\Software\Microsoft\Windows\CurrentVersion\Policies\Explorer" | Out-Null
	}
...
Function HideTrayIcons {
	If ($global:accept) {
	$Readhost = Read-Host "- Compattare le icone visualizzate nella traybar? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione visualizzazione nascosta delle icone della traybar..."
...
Function DisableSearchAppInStore {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare la ricerca di app nel Microsoft Store per le estensioni sconosciute? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione app per la gestione di file con estensione sconosciuta..."
...
Function EnableSearchAppInStore {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare la ricerca di app nel Microsoft Store per le estensioni sconosciute? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione ricerca app per la gestione di file con estensione sconosciuta..."
...
Function DisableShortcutInName {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare l'aggiunta della voce - Collegamento ai nomi dei file? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione aggiunta '- collegamento' ai nomi dei link..."
...
Function EnableShortcutInName {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare l'aggiunta della voce - Collegamento ai nomi dei file? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione aggiunta '- collegamento' ai nomi dei link..."
...
Function SetVisualFXPerformance {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare gli effetti visuali (disattiva animazioni e finestre trasparenti)? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione degli effetti grafici piu' pesanti..."
...
Function SetVisualFXAppearance {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare gli effetti visuali (attiva animazioni e finestre trasparenti)? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Abilitazione di tutti gli effetti grafici..."
...
Function ShowKnownExtensions {
	If ($global:accept) {
	$Readhost = Read-Host "- Mostrare le estensioni dei file? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione visualizzazione estensioni file..."
...
Function HideKnownExtensions {
	If ($global:accept) {
	$Readhost = Read-Host "- Nascondere le estensioni dei file? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione visualizzazione estensioni file conosciuti..."
...
Function ShowHiddenFiles {
	If ($global:accept) {
	$Readhost = Read-Host "- Mostrare i file nascosti? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione visualizzazione file nascosti..."
...
Function HideHiddenFiles {
	If ($global:accept) {
	$Readhost = Read-Host "- Non visualizzare i file nascosti? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione visualizzazione file nascosti..."
...
Function SetExplorerThisPC {
	If ($global:accept) {
	$Readhost = Read-Host "- Impostare Questo PC come visualizzazione predefinita in Esplora file? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Impostazione della finestra Questo PC come predefinita in Esplora file..."
...
Function SetExplorerQuickAccess {
	If ($global:accept) {
	$Readhost = Read-Host "- Impostare Accesso rapido come visualizzazione predefinita in Esplora file? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Impostazione Accesso rapido come finestra predefinita in Esplora file..."
...
Function ShowThisPCOnDesktop {
	If ($global:accept) {
	$Readhost = Read-Host "- Mostrare icona Questo PC sul desktop? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Visualizzazione icona Questo PC sul desktop..."
	If (!(Test-Path "HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\HideDesktopIcons\ClassicStartMenu")) {
		New-Item -Path "HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\HideDesktopIcons\ClassicStartMenu" -Force | Out-Null
	}
...
Function HideThisPCFromDesktop {
	If ($global:accept) {
	$Readhost = Read-Host "- Nascondere icona Questo PC sul desktop? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Eliminazione icona Questo PC dal desktop..."
...
Function DisableOneDrive {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare OneDrive? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione OneDrive..."
...
Function EnableOneDrive {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare OneDrive? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione OneDrive..."
...
Function UninstallOneDrive {
	If ($global:accept) {
	$Readhost = Read-Host "- Disinstallare completamente OneDrive? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disinstallazione OneDrive..."
...
Function InstallOneDrive {
	If ($global:accept) {
	$Readhost = Read-Host "- Installare OneDrive? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Installazione OneDrive..."
	$onedrive = "$env:SYSTEMROOT\SysWOW64\OneDriveSetup.exe"
	If (!(Test-Path $onedrive)) {
		$onedrive = "$env:SYSTEMROOT\System32\OneDriveSetup.exe"
	}
...
Function UninstallMsftApps {
	If ($global:accept) {
	$Readhost = Read-Host "- Si desiderano disinstallare tutte le app UWP Microsoft? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disinstallazione app Microsoft UWP..."
...
Function InstallMsftApps {
	Write-Output "Installazione app Microsoft UWP predefinite..."
...
function UninstallThirdPartyApps {
	If ($global:accept) {
	$Readhost = Read-Host "- Rimuovere le app UWP di terze parti potenzialmente inutili? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Rimozione app di terze parti potenzialmente inutili..."
...
Function InstallThirdPartyApps {
	If ($global:accept) {
	$Readhost = Read-Host "- Installare le app UWP di terze parti potenzialmente inutili? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Instalazione app di terze parti..."
...
Function DisableXboxFeatures {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare le funzionalita' Xbox? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione funzionalita' Xbox..."
...
Function EnableXboxFeatures {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare le funzionalita' Xbox? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione funzinalita' Xbox..."
...
Function DisableAdobeFlash {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare Adobe Flash in Edge e Internet Explorer? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione Adobe Flash in IE ed Edge..."
...
Function EnableAdobeFlash {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare Adobe Flash in Edge e Internet Explorer? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione Adobe Flash in IE ed Edge..."
...
Function DisableEdgeShortcutCreation {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare la creazione di un collegamento a Edge? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione collegamento a Edge..."
...
Function EnableEdgeShortcutCreation {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare la creazione di un collegamento a Edge? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione creazione collegamento a Edge..."
...
Function UninstallXPSPrinter {
	If ($global:accept) {
	$Readhost = Read-Host "- Rimuovere la stampante XPS? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disinstallazione stampante virtuale Microsoft XPS..."
...
Function InstallXPSPrinter {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare la stampante XPS? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione stampante virtuale Microsoft XPS..."
...
Function RemoveFaxPrinter {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare la stampante fax? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
...
Function AddFaxPrinter {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare la stampante fax? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione stampante virtuale fax..."
...
Function UnpinStartMenuTiles {
	If ($global:accept) {
	$Readhost = Read-Host "- Effettuare l'unpinning delle piastrelle nel menu Start? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Unpinning piastrelle del menu Start..."
...
Function RegistryBackup {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare il backup periodico del registro di sistema? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione backup registro di sistema..."
...
Function NoRegistryBackup {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare il backup periodico del registro di sistema? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	 ...
	 Write-Output "Disattivazione backup registro di sistema..."
...
Function NoReservedSpace {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare lo spazio riservato? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione spazio riservato..."
	If (!(Test-Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\ReserveManager")) {
		New-Item -Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\ReserveManager" -Force | Out-Null
	}	
...
Function ReservedSpace {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare lo spazio riservato? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione spazio riservato..."
	If (!(Test-Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\ReserveManager")) {
		New-Item -Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\ReserveManager" -Force | Out-Null
	}	
...
Function LockedStartMenu {
	If ($global:accept) {
	$Readhost = Read-Host "- Bloccare il layout del menu Start per tutti gli utenti? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Blocco del layout del menu Start..."
	Export-StartLayout -path C:\Backup_MenuStart.xml
	If (!(Test-Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\Explorer")) {
	...
	Set-ItemProperty -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\Explorer" -Name "StartLayoutFile" -Type ExpandString -Value "`"C:\Backup_MenuStart.xml`""
}

Function UnLockedStartMenu {
	If ($global:accept) {
	$Readhost = Read-Host "- Sbloccare il layout del menu Start per tutti gli utenti? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Sblocco del layout del menu Start..."
	Remove-ItemProperty -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\Explorer" -Name "LockedStartLayout" -ErrorAction SilentlyContinue
	Remove-ItemProperty -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\Explorer" -Name "StartLayoutFile" -ErrorAction SilentlyContinue
}

Function NoSecurityQuestions {
	If ($global:accept) {
	$Readhost = Read-Host "- Disattivare le domande di sicurezza per gli account utente? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Disattivazione domande di sicurezza account utente..."
...
Function SecurityQuestions {
	If ($global:accept) {
	$Readhost = Read-Host "- Attivare le domande di sicurezza per gli account utente? " 
    Switch ($ReadHost) 
     { 
	   S {continue}
       N {return} 
	...
	Write-Output "Attivazione domande di sicurezza account utente..."
	Remove-ItemProperty -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\System" -Name "NoLocalPasswordResetQuestions" -ErrorAction SilentlyContinue
}
...
# Wait for key press
Function WaitForKey {
	Write-Output "`nChiudere tutti i programmi in esecuzione e premere un tasto per riavviare il PC..."
